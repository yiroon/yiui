function yiuiSmsCodeBox(opts){
    ...
    var codeHtml = '\
        ...
        <div class="input-smscode-inner" style="background-color: #FFF;position:relative;width:500px;max-width:100%;padding:2rem;border-radius:0.5rem;">\
            ...
            <div style="text-align:center;margin-top:2rem;">\
                <button class="input-smscode-submit" style="border:0;background:#2700F3;color:#FFF;-webkit-appearance: none;padding:1rem 3rem;border-radius:0.5rem;font-size:1.125rem;display: inline-block;outline: none;">确定</button>\
            </div>\
        </div>\
    </div>';
    ...
    function smsCodeInput_destroy(){
        ...
        inputSmscodeCloseButton.removeEventListener('click',smsCodeInput_destroy);
    ...
    inputSmscodeCloseButton.addEventListener('click',smsCodeInput_destroy,false);
    document.querySelector('.input-smscode-inner').addEventListener('click',smsCodeInput_setfocus,false);
    return {destroy:smsCodeInput_destroy};
}
